...
#ifndef TEMPLATE_NON_COPIED_CLASS_2_HPP
#define TEMPLATE_NON_COPIED_CLASS_2_HPP
...
class non_copied_stack_2 {
 ...
 public:
  non_copied_stack_2() = default;//конструктор по умолчанию
  non_copied_stack_2(const non_copied_stack_2& stack) = delete;//запрет неявного копирования
  non_copied_stack_2(non_copied_stack_2&& stack) noexcept = default;
  auto operator=(const non_copied_stack_2& stack) = delete;
  auto operator=(non_copied_stack_2&& stack) noexcept -> non_copied_stack_2& = default;
...
#endif  // TEMPLATE_NON_COPIED_CLASS_2_HPP
